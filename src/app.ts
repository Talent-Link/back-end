...
import { userRoutes, candidateProfileRoutes, resumeAnalysisRoutes } from "./domains/user";
...
import emailTestRoutes from "./domains/notification/routes/emailTestRoutes";
...
app.use("/email-test", emailTestRoutes);
